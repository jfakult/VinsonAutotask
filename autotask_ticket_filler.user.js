// ==UserScript==
// @name         Autoload Ticket Info
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Automatically fills in various fields in the create ticket screen
// @author       You
// @include      https*autotask*TicketNew*Create*
// @grant        none
// ==/UserScript==

// If you want to edit some things, find the section below (line 122) with the label "CHANGE THESE THINGS". Feel free to change those things.
// Or if you know what you are doing, just find the sections labeled DONT CHANGE THESE THINGS and blatantly ignore my recommendations
...
var l = document.getElementsByClassName("ItemSet Standard")[LIST_NUMBER]
var ll = l.innerHTML.split("</span")
var s = "";
for (var i = 0; i < ll.length-1; i++)
{
    s += '\t"' + (ll[i].split("span>")[1].toUpperCase().replace(" ", "_")) + '": ' + (i+1) + ",\n"
}
console.log(s)
*/